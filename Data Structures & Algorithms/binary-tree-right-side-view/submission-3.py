...
class Solution:
    def rightSideView(self, root: Optional[TreeNode]) -> List[int]:
        ...
        def dfs(root, depth):
            ...
            # since the right node is visited the first, the first node visited in the level is the rightmost node
            if depth == len(res):
                res.append(root.val)
    ...
    def rightSideView_dfs_og(self, root: Optional[TreeNode]) -> List[int]:
        """
            dfs solution
        """
        res = []
